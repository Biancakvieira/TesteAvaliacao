...
public class CadastroTest {
    ...
    public static void setUpBeforeClass() throws Exception {
        ...
        /*cadastroPagesPJCnpjErro = new CadastroPagesPJ_CNPJ_ERRO(driver);*/
        ...
        @Test
        public void CadastroPagesPF_CPF_ERRO() { cadastroPagesPF_cpf_erro.preencherCampoPF_CPF_ERRO();
        }

        @Test
        public void CadastroPagesPF_DN_ERRO() {cadastroPagesPF_Dn_ERRO.preencherCampoPF_DN_ERRO();
        }

        @Test
        public void CadastroPagesPJ_CNPJ_ERRO() {cadastroPagesPJ_CNPJ_ERRO.preencherCampoPJ_CNPJ_ERRO();
        }
